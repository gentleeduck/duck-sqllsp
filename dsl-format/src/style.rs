...
fn default_kw_case() -> String {
  "upper".into()
}
fn default_lines() -> usize {
  1
}
fn default_data_case() -> String {
  "preserve".into()
}
fn default_fn_case() -> String {
  "lower".into()
}
fn default_expr_width() -> usize {
  80
}
fn default_lon() -> String {
  "before".into()
}
