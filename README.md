<p align="center">
  <img src="./public/logo-dark.svg" alt="duck-gate" width="120"/>
</p>

<h1 align="center">duck-gate</h1>
...
| [`dgw-cli`](crates/dgw-cli) | `duck-gate` binary (run, check, reload) |
