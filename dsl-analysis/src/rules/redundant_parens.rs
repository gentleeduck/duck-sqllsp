...
impl LintRule for Rule {
    fn code(&self) -> &'static str { "sql055" }
    ...
    fn check(
        ...
        if !matches!(
            stmt.kind,
            StatementKind::Select(_) | StatementKind::Update(_) | StatementKind::Delete(_)
        ) { return; }
