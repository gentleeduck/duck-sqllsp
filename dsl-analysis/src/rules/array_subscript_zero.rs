...
impl LintRule for Rule {
    fn code(&self) -> &'static str { "sql148" }
            ...
            if bytes[i] == b'[' {
                ...
                if bad {
                    ...
                    out.push(Diagnostic {
                        ...
                        message: format!("array subscript `[{lit}]` -- PG arrays are 1-based by default, `[0]` and negative indexes return NULL"),
