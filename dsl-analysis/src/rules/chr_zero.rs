//! sql698: `chr(0)` -- PostgreSQL forbids the null character: `chr(0)` raises
//! 54000 ("null character not permitted"). Usually a placeholder or an
//! off-by-one (ASCII codes start at 1 for usable characters). Use a real code
//! point.
    ...
    while i < n {
        ...
        && &upper[s..e] == "0"
      {
        out.push(Diagnostic {
          ...
          message: "chr(0) is the null character, which PostgreSQL forbids (raises 54000)".into(),
