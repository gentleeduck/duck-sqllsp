...
impl LintRule for Rule {
    fn code(&self) -> &'static str { "sql156" }
    ...
    fn check(
        ...
        if !upper.contains("LANGUAGE PLPGSQL") && !upper.contains("DO $$") { return; }
        ...
        out.push(Diagnostic {
            ...
            message: "SELECT INTO STRICT without surrounding EXCEPTION WHEN -- NO_DATA_FOUND / TOO_MANY_ROWS aborts the transaction".into(),
