...
impl LintRule for Rule {
    fn code(&self) -> &'static str { "sql144" }
    ...
    fn check(
        ...
        let on_delete = upper.contains("DELETE")
        ...
        if !after_trim.starts_with('(') { return; }
        ...
        if !when_up.contains("NEW.") && !word_in(&when_up, "NEW") { return; }
        ...
        out.push(Diagnostic {
            ...
            message: "AFTER/BEFORE DELETE trigger references NEW -- there is no NEW row on DELETE, the trigger raises at runtime".into(),
