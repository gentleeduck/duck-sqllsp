//! sql491: `HAVING 1 = 1` (tautology) / `HAVING 1 = 2` (contradiction)
//! / `HAVING 'a' = 'b'` -- equality (or `<>`/`!=`) between two constant
//! literals in HAVING is independent of row data. Counterpart to
//! sql474 for the HAVING clause.
