...
const KEYWORDS: &[&str] = &[
  ...
  "JSON",
  "JSONB",
  // Parameterised types from the other dialects. A column declared
  // `NVARCHAR(160)` is not a call to a function named NVARCHAR, and on SQLite,
  // where the type is whatever you wrote, these turn up constantly.
  "NVARCHAR",
  "NCHAR",
  "NTEXT",
  "TINYINT",
