...
impl LintRule for Rule {
    fn code(&self) -> &'static str { "sql140" }
    ...
    fn check(
        ...
        let on_insert = upper.contains("INSERT")
        ...
        if !when_up.contains("OLD.") && !word_in(&when_up, "OLD") { return; }
        ...
        out.push(Diagnostic {
            ...
            message: "AFTER/BEFORE INSERT trigger references OLD -- there is no OLD row on INSERT, the trigger raises at runtime".into(),
