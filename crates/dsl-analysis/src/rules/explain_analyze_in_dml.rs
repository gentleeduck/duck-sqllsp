...
impl LintRule for Rule {
    fn code(&self) -> &'static str { "sql125" }
    ...
    fn check(
        ...
        out.push(Diagnostic {
            ...
            message: "EXPLAIN ANALYZE on DML executes the statement -- wrap in BEGIN ... ROLLBACK if you only want the plan".into(),
