...
impl LintRule for Rule {
    fn code(&self) -> &'static str { "sql129" }
    ...
    fn check(
        ...
        let name: String = rest_after_ine.chars()
        ...
        out.push(Diagnostic {
            ...
            message: format!("CREATE TABLE `{name}` has no following `ALTER TABLE ... OWNER TO` -- ownership defaults to the migration user"),
