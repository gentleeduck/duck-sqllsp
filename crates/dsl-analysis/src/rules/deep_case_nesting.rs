...
impl LintRule for Rule {
    fn code(&self) -> &'static str { "sql094" }
    ...
    fn check(
        ...
        if max_depth > MAX_DEPTH {
            ...
            out.push(Diagnostic {
                ...
                message: format!(
                    "CASE expressions nested {max_depth} deep -- consider a lookup table or helper function"
                ),
                range,
            });
        }
