...
impl LintRule for Rule {
    fn code(&self) -> &'static str { "sql030" }
    ...
    fn check(
        ...
        out.push(Diagnostic {
            ...
            message: "trigger function has no RETURN -- add `RETURN NEW;`, `RETURN OLD;`, or `RETURN NULL;` before the END".into(),
            range,
        });
    }
}
