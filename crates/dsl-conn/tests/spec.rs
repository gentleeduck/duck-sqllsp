...
fn url_for_postgres_with_password() {
    let s = ConnectionSpec {
        name: "n".into(), driver: "postgres".into(),
        host: Some("h".into()), port: Some(5433),
        user: Some("u".into()), password: Some("p".into()),
        database: Some("d".into()), schema: None,
    };
...
fn url_for_postgres_without_password() {
    let s = ConnectionSpec {
        name: "n".into(), driver: "postgresql".into(),
        host: None, port: None, user: Some("u".into()),
        password: None, database: Some("d".into()), schema: None,
    };
